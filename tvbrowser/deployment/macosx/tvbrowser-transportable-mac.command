...
echo "Command line is" ${JAVA_DIR}/java '-Xms16m -Xmx512m --module-path=\"lib:tvbrowser.jar\" -Dapple.laf.useScreenMenuBar=true -Dcom.apple.macos.use-file-dialog-packages=true -Dcom.apple.mrj.application.apple.menu.about.name=TV-Browser -Dcom.apple.smallTabs=true -Djava.library.path=\"${PROGRAM_DIR}\" -splash:imgs/splash.png -m tvbrowser/tvbrowser.TVBrowser \"$@\"'

$cmdLine
"${JAVA_DIR}/java" -Xms16m -Xmx512m --module-path="lib:tvbrowser.jar" -Dapple.laf.useScreenMenuBar=true -Dcom.apple.macos.use-file-dialog-packages=true -Dcom.apple.smallTabs=true -Djava.library.path="${PROGRAM_DIR}" -splash:imgs/splash.png -m tvbrowser/tvbrowser.TVBrowser "$@"
