...
public class ActionMenu {
   ...
   */
  @Deprecated(since="3.0") public ActionMenu(Action action, ActionMenu[] subItems) {
    mAction = action;
    mSubItems = subItems;
  }
   ...
   */
  @Deprecated(since="3.0") public ActionMenu(Action action, Action[] subItems) {
    mAction = action;
   ...
   */
  @Deprecated(since="3.0") public ActionMenu(Action action, Object[] subItems) {
    mAction = action;
