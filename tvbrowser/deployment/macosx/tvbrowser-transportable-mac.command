...
$cmdLine
"${JAVA_DIR}/java" -Xms16m -Xmx1G --module-path="lib:tvbrowser.jar" -Dapple.laf.useScreenMenuBar=true -Dcom.apple.macos.use-file-dialog-packages=true -Dcom.apple.smallTabs=true -Djava.library.path="${PROGRAM_DIR}" -splash:imgs/splash.png -m tvbrowser/tvbrowser.TVBrowser "$@"
