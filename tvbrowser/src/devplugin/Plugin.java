 ...
 */
abstract public class Plugin implements Marker, ContextMenuIf, ProgramReceiveIf, PluginSettings.Preferences, PluginSettings.Data, Excludable {
   ...
   * 
   * @param type The type of the event that caused the sending of the programs.
