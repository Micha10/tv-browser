...
public interface ProgramReceiveIf extends Comparable<ProgramReceiveIf> {
   ...
   * Receives a list of Strings from another plugin with a target.
   *
   * @param eventType The type of the programs send by other plugin.
   * @param values
   ...
   * @since 4.2.2
   */
  public boolean receiveValues(int eventType, String[] values, ProgramReceiveTarget receiveTarget);
